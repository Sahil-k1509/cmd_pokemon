...
# Water type
watergun = Attack(name='watergun', attCategory='water', baseDamage=25, pokemonLevel=0, baseCount=10, recoil=0, heal=0, accuracy=0.9)
...
hydropump = Attack(name='hydro pump', attCategory='water', baseDamage=87, pokemonLevel=0, baseCount=8, recoil=0, heal=0, accuracy=1)
...
# Grass type
vinewhip = Attack(name='vine whip', attCategory='grass', baseDamage=22, pokemonLevel=0, baseCount=10, recoil=0, heal=0, accuracy=1)
razorleaf = Attack(name='razor leaf', attCategory='grass', baseDamage=15, pokemonLevel=0, baseCount=7, recoil=0, heal=0, accuracy=1)
stunspore = Attack(name='stun spore', attCategory='grass', baseDamage=18, pokemonLevel=0, baseCount=5, recoil=0, heal=0, accuracy=0.5)
gigadrain = Attack(name='giga drain', attCategory='grass', baseDamage=90, pokemonLevel=0, baseCount=3, recoil=0, heal=40, accuracy=0.9)
...
whirlwind = Attack(name='whirl wind', attCategory='flying', baseDamage=15, pokemonLevel=0, baseCount=7, recoil=0, heal=0, accuracy=1)
...
tackle = Attack(name='tackle', attCategory='normal', baseDamage=10, pokemonLevel=0, baseCount=13, recoil=0, heal=0, accuracy=1)
...
quickattack = Attack(name='quick attack', attCategory='normal', baseDamage=20, pokemonLevel=0, baseCount=9, recoil=0, heal=0, accuracy=1)
scratch = Attack(name='scratch', attCategory='normal', baseDamage=10, pokemonLevel=0, baseCount=9, recoil=0, heal=0, accuracy=1)
cut = Attack(name='cut', attCategory='normal', baseDamage=15, pokemonLevel=0, baseCount=13, recoil=0, heal=0, accuracy=0.9)
headbutt = Attack(name='headbutt', attCategory='normal', baseDamage=13, pokemonLevel=0, baseCount=10, recoil=0, heal=0, accuracy=0.75)
disable = Attack(name='disable', attCategory='normal', baseDamage=70, pokemonLevel=0, baseCount=5, recoil=0, heal=0, accuracy=1)
...
aurorabeam = Attack(name='aurora beam', attCategory='ice', baseDamage=80, pokemonLevel=0, baseCount=5, recoil=0, heal=0, accuracy=0.9)
icebeam = Attack(name='ice beam', attCategory='ice', baseDamage=70, pokemonLevel=0, baseCount=4, recoil=0, heal=0, accuracy=1)
icywind = Attack(name='icy wind', attCategory='ice', baseDamage=50, pokemonLevel=0, baseCount=6, recoil=0, heal=0, accuracy=0.9)
blizzard = Attack(name='blizzard', attCategory='ice', baseDamage=190, pokemonLevel=0, baseCount=3, recoil=30, heal=0, accuracy=1)
...
earthquake = Attack(name='earthquake', attCategory='ground', baseDamage=140, pokemonLevel=0, baseCount=4, recoil=0, heal=0, accuracy=1)
mudslap = Attack(name='mudslap', attCategory='ground', baseDamage=26, pokemonLevel=0, baseCount=6, recoil=0, heal=0, accuracy=0.9)
...
leechlife = Attack(name='leech life', attCategory='bug', baseDamage=14, pokemonLevel=0, baseCount=6, recoil=0, heal=7, accuracy=1)
...
# Dark type
bite = Attack(name='bite', attCategory='dark', baseDamage=50, pokemonLevel=0, baseCount=7, recoil=0, heal=0, accuracy=1)
...
pursuit = Attack(name='pursuit', attCategory='dark', baseDamage=60, pokemonLevel=0, baseCount=5, recoil=0, heal=0, accuracy=0.9)
