...
# Fire type
flamethrower = Attack(name='flamethrower', attCategory='fire', baseDamage=90, pokemonLevel=0, baseCount=7, recoil=0, heal=0, accuracy=1)
ember = Attack(name='ember', attCategory='fire', baseDamage=56, pokemonLevel=0, baseCount=6, recoil=0, heal=0, accuracy=0.65)
firepunch = Attack(name='fire punch', attCategory='fire', baseDamage=67, pokemonLevel=0, baseCount=8, recoil=0, heal=0, accuracy=0.9)
firespin = Attack(name='fire spin', attCategory='fire', baseDamage=35, pokemonLevel=0, baseCount=15, recoil=0, heal=0, accuracy=0.8)
...
fireblast = Attack(name='fire blast', attCategory='fire', baseDamage=110, pokemonLevel=0, baseCount=4, recoil=30, heal=0, accuracy=0.85)
...
# Electric type
thundershock = Attack(name='thundershock', attCategory='electric', baseDamage=30, pokemonLevel=0, baseCount=10, recoil=0, heal=0, accuracy=0.9)
thunderbolt = Attack(name='thunderbolt', attCategory='electric', baseDamage=70, pokemonLevel=0, baseCount=6, recoil=0, heal=0, accuracy=0.95)
thunderpunch = Attack(name='thunder punch', attCategory='electric', baseDamage=67, pokemonLevel=0, baseCount=8, recoil=0, heal=0, accuracy=0.96)
...
# Water type
watergun = Attack(name='watergun', attCategory='water', baseDamage=30, pokemonLevel=0, baseCount=10, recoil=0, heal=0, accuracy=0.9)
...
bubblebeam = Attack(name='bubblebeam', attCategory='water', baseDamage=80, pokemonLevel=0, baseCount=8, recoil=40, heal=0, accuracy=0.8)
...
# Grass type
vinewhip = Attack(name='vine whip', attCategory='grass', baseDamage=30, pokemonLevel=0, baseCount=10, recoil=0, heal=0, accuracy=1)
razorleaf = Attack(name='razor leaf', attCategory='grass', baseDamage=40, pokemonLevel=0, baseCount=7, recoil=0, heal=0, accuracy=1)
stunspore = Attack(name='stun spore', attCategory='grass', baseDamage=27, pokemonLevel=0, baseCount=5, recoil=0, heal=0, accuracy=0.5)
...
# Flying type
gust = Attack(name='gust', attCategory='flying', baseDamage=30, pokemonLevel=0, baseCount=10, recoil=0, heal=0, accuracy=1)
whirlwind = Attack(name='whirl wind', attCategory='flying', baseDamage=40, pokemonLevel=0, baseCount=7, recoil=0, heal=0, accuracy=1)
wingattack = Attack(name='wing attack', attCategory='flying', baseDamage=47, pokemonLevel=0, baseCount=7, recoil=0, heal=0, accuracy=1)
...
# Normal type
pound = Attack(name='pound', attCategory='normal', baseDamage=30, pokemonLevel=0, baseCount=10, recoil=0, heal=0, accuracy=1)
tackle = Attack(name='tackle', attCategory='normal', baseDamage=35, pokemonLevel=0, baseCount=13, recoil=0, heal=0, accuracy=1)
...
quickattack = Attack(name='quick attack', attCategory='normal', baseDamage=55, pokemonLevel=0, baseCount=9, recoil=0, heal=0, accuracy=1)
scratch = Attack(name='scratch', attCategory='normal', baseDamage=45, pokemonLevel=0, baseCount=9, recoil=0, heal=0, accuracy=1)
cut = Attack(name='cut', attCategory='normal', baseDamage=30, pokemonLevel=0, baseCount=13, recoil=0, heal=0, accuracy=0.9)
headbutt = Attack(name='headbutt', attCategory='normal', baseDamage=40, pokemonLevel=0, baseCount=10, recoil=0, heal=0, accuracy=0.75)
...
# Ground type
sandattack = Attack(name='sandattack', attCategory='ground', baseDamage=70, pokemonLevel=0, baseCount=7, recoil=0, heal=0, accuracy=1)
dig = Attack(name='dig', attCategory='ground', baseDamage=50, pokemonLevel=0, baseCount=5, recoil=0, heal=0, accuracy=1)
earthquake = Attack(name='earthquake', attCategory='ground', baseDamage=80, pokemonLevel=0, baseCount=4, recoil=0, heal=0, accuracy=1)
mudslap = Attack(name='mudslap', attCategory='ground', baseDamage=40, pokemonLevel=0, baseCount=6, recoil=0, heal=0, accuracy=0.9)
landwrath = Attack(name='land\'s wrath', attCategory='ground', baseDamage=70, pokemonLevel=0, baseCount=3, recoil=30, heal=0, accuracy=1)


# Poison type
posionsting = Attack(name='posion sting', attCategory='posion', baseDamage=30, pokemonLevel=0, baseCount=9, recoil=0, heal=0, accuracy=0.8)
posionpowder = Attack(name='posion powder', attCategory='posion', baseDamage=40, pokemonLevel=0, baseCount=9, recoil=0, heal=0, accuracy=1)
acid = Attack(name='acid', attCategory='posion', baseDamage=50, pokemonLevel=0, baseCount=6, recoil=0, heal=0, accuracy=1)
...
poisonfang = Attack(name='poison fang', attCategory='posion', baseDamage=40, pokemonLevel=0, baseCount=6, recoil=0, heal=0, accuracy=0.9)


# Bug type
stringshot = Attack(name='string shot', attCategory='bug', baseDamage=20, pokemonLevel=0, baseCount=9, recoil=0, heal=0, accuracy=0.9)
leechlife = Attack(name='leech life', attCategory='bug', baseDamage=40, pokemonLevel=0, baseCount=6, recoil=0, heal=40, accuracy=1)
megahorn = Attack(name='mega horn', attCategory='bug', baseDamage=120, pokemonLevel=0, baseCount=4, recoil=0, heal=0, accuracy=1)
bugbite = Attack(name='bug bite', attCategory='bug', baseDamage=80, pokemonLevel=0, baseCount=4, recoil=0, heal=0, accuracy=1)
stinger = Attack(name='stinger', attCategory='bug', baseDamage=40, pokemonLevel=0, baseCount=6, recoil=0, heal=0, accuracy=0.9)
