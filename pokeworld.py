...
pokemonWorld = {
    ...
    'startyu': {'type': 'water', 'evolveAt': 16, 'evolveTo': 'starmie', 'baseDef': 13, 'baseSpeed': 15, 'startAttacks': [watergun, swift, None, None], 'learnableAttacks': [tackle, bubblebeam, quickattack, hydropump, watercannon, waterspout, hydrovortex][::-1] },           
