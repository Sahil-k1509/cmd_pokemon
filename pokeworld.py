...
pokemonWorld = {
    ...
    'startyu':      {'type': 'water',       'evolveAt': 16,     'evolveTo': 'starmie',      'baseDef': 13,  'baseSpeed': 15, 'startAttacks': [deepcopy(watergun), deepcopy(swift), None, None],                     'learnableAttacks': [deepcopy(tackle), deepcopy(bubblebeam), deepcopy(quickattack), deepcopy(hydropump), deepcopy(watercannon), deepcopy(waterspout), deepcopy(hydrovortex)][::-1]        },           
